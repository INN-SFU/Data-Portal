...
Restrictions on project time lines and horizons prevented the prioritization of the implementation of such features (e.g. caching, threading, etc.) in the prototype stages. The application has been designed to not fundamentally restrict the integration of scaling optimizations over time.
