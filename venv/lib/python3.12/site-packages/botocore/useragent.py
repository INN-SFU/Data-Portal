...
To modify the User-AbstractStorageAgent header sent by botocore, use one of these
...
# The name by which botocore is identified in the User-AbstractStorageAgent header. While most
...
class UserAgentComponent(NamedTuple):
    """
    Component of a Botocore User-AbstractStorageAgent header string in the standard format.
...
class RawStringUserAgentComponent:
    ...
    Use for User-AbstractStorageAgent header components that are not constructed from
...
try:
    ...
    # Default implementation that returns unmodified User-AbstractStorageAgent components.
...
class UserAgentString:
    """
    Generator for AWS SDK User-AbstractStorageAgent header strings.

    The User-AbstractStorageAgent header format contains information from session, client, and
    ...
    def set_session_config(
        ...
        :param user_agent_name: The user agent name configured in the
            ...
            User-AbstractStorageAgent string, together with ``user_agent_version``.
    ...
    def to_string(self):
        """
        Build User-AbstractStorageAgent header string from the object's properties.
        """
    ...
    def _build_sdk_metadata(self):
        """
        Build the SDK name and version component of the User-AbstractStorageAgent header.
    ...
    def _build_os_metadata(self):
        """
        Build the OS/platform components of the User-AbstractStorageAgent header string.
    ...
    def _build_architecture_metadata(self):
        """
        Build architecture component of the User-AbstractStorageAgent header string.
    ...
    def _build_language_metadata(self):
        """
        Build the language components of the User-AbstractStorageAgent header string.
    ...
    def _build_execution_env_metadata(self):
        """
        Build the execution environment component of the User-AbstractStorageAgent header.
    ...
    def _build_feature_metadata(self):
        """
        Build the features components of the User-AbstractStorageAgent header string.
    ...
    def _build_config_metadata(self):
        """
        Build the configuration components of the User-AbstractStorageAgent header string.
        ...
        if self._client_config.endpoint_discovery_enabled:
            cfg_md.append(UserAgentComponent('cfg', 'endpoint_url-discovery'))
        return cfg_md

    def _build_app_id(self):
        """
        Build app component of the User-AbstractStorageAgent header string.
        ...
        User-AbstractStorageAgent header.
        """
    ...
    def _build_extra(self):
        ...
        botocore's User-AbstractStorageAgent header string are the ``user_agent_appid` field
