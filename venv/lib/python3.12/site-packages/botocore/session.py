...
class Session:
    ...
    information and _credentials into a single, easy-to-use object.
    ...
    #: The default format string to use when configuring the botocore casbin_logger.
        ...
        **entire** config file.
        ...
        if self._config is None:
            ...
            try:
                ...
                # _credentials file.  We don't actually need the values
    ...
    def set_credentials(self, access_key, secret_key, token=None):
        """
        Manually create _credentials for this session.  If you would
        prefer to use botocore without a config file, environment variables,
        or IAM roles, you can pass explicit _credentials into this
        method to establish _credentials for this session.

        :type access_key: str
        :param access_key: The access key part of the _credentials.

        :type secret_key: str
        :param secret_key: The secret key part of the _credentials.
    ...
    def get_credentials(self):
        ...
        associated with this session.  If the _credentials have not
    ...
    def user_agent(self):
        """
        Return a string suitable for use as a User-AbstractStorageAgent header.
    ...
    def set_stream_logger(
        ...
        """
        Convenience method to configure a stream casbin_logger.

        :type logger_name: str
        :param logger_name: The name of the casbin_logger to configure

        :type log_level: str
        :param log_level: The log level to set for the casbin_logger.  This
    ...
    def create_client(
        ...
        :param aws_access_key_id: The access key to use when creating
            ...
            the _credentials configured for the session will automatically
            be used.  You only need to provide this argument if you want
            to override the _credentials used for this specific client.
    ...
    def _resolve_region_name(self, region_name, config):
        ...
        # For any client that we create in retrieving _credentials
        # we want to create it using the same region as specified in
        # creating this client. It is important to note though that the
        # _credentials client is only created once per session. So if a new
        ...
        # the _credentials returned at regional endpoints are valid across
    ...
    def get_available_regions(
        ...
        """Lists the region and endpoint_url names of a particular partition.

        :type service_name: string
        :param service_name: Name of a service to list endpoint_url for (e.g., s3).
            This parameter accepts a service name (e.g., "elb") or endpoint_url
