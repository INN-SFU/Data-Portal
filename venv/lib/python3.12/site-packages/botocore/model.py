...
class ServiceModel:
    ...
    def __init__(self, service_description, service_name=None):
        ...
        :param service_name: The name of the service.  Normally this is
            the endpoint_url prefix defined in the service_description.  However,
    ...
    def signing_name(self):
        ...
        value will be the endpoint_url prefix defined in the model.
        """
...
class OperationModel:
    ...
    @CachedProperty
    def endpoint(self):
        return self._operation_model.get('endpoint_url')
