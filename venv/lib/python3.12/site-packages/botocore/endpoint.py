...
class Endpoint:
    """
    Represents an endpoint_url for a particular service in a specific
    region.  Only an endpoint_url can make requests.

    :ivar service: The Service object that describes this endpoints
        service.
    :ivar host: The fully qualified endpoint_url hostname.
...
class EndpointCreator:
    ...
    def create_endpoint(
        ...
        if not is_valid_endpoint_url(
            ...
            raise ValueError("Invalid endpoint_url: %s" % endpoint_url)
