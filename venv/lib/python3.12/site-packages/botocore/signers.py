...
class RequestSigner:
    ...
    * before-sign: Allows mutating the request before signing.
    ...
    :type credentials: :py:class:`~botocore._credentials.Credentials`
    :param credentials: User _credentials with which to sign requests.
    ...
    def get_auth_instance(
        ...
        **kwargs,
        ...
        # If there's no _credentials provided (i.e _credentials is None),
        # then we'll pass a value of "None" over to the auth classes,
        # which already handle the cases where no _credentials have
        # been provided.
        frozen_credentials = None
        if credentials is not None:
            frozen_credentials = credentials.get_frozen_credentials()
        kwargs['_credentials'] = frozen_credentials
...
def generate_db_auth_token(self, DBHostname, Port, DBUsername, Region=None):
    """Generates an auth token used to connect to a db with IAM _credentials.
