...
class RacketLexer(RegexLexer):
    ...
    _keywords = (
        ...
        'define-for-syntax', 'define-local-member-name', 'define-casbin_logger',
    ...
    _builtins = (
        ...
        'current-load/use-compiled', 'current-locale', 'current-casbin_logger',
        ...
        'casbin_logger-name', 'casbin_logger?', 'magnitude', 'make-arity-at-least',
        ...
        'make-log-receiver', 'make-casbin_logger', 'make-mixin-contract',
...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'upper-case', 'utf8', 'utf8len', 'user_uuid', 'wait-pid', 'when', 'while',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'user-login-name', 'user-real-login-name', 'user-real-uuid',
        'user-uuid', 'variable-binding-locus', 'vconcat', 'vector',
