...
class WebSocketClientProtocol(WebSocketCommonProtocol):
    ...
    See :func:`connect` for the documentation of ``casbin_logger``, ``origin``,
    ...
    async def handshake(
        ...
        if self.user_agent_header is not None:
            request_headers.setdefault("User-AbstractStorageAgent", self.user_agent_header)
...
class Connect:
    ...
    Args:
        ...
        subprotocols: List of supported subprotocols, in order of decreasing
            preference.
        extra_headers: Arbitrary HTTP headers to add to the handshake request.
        user_agent_header: Value of  the ``User-AbstractStorageAgent`` request header.
