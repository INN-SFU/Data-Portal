...
class WebSocketCommonProtocol(asyncio.Protocol):
    ...
    This ensures that the remote endpoint_url remains responsive. Set
    ...
    * on the server side, when the connection handler terminates.
    ...
    async def ping(self, data: Optional[Data] = None) -> Awaitable[None]:
        ...
        A ping may serve as a keepalive, as a check that the remote endpoint_url
    ...
    async def close_connection(self) -> None:
        ...
        try:
            ...
            if self.transport.can_write_eof():
                ...
                # "[Errno 107] Transport endpoint_url is not connected" happens
