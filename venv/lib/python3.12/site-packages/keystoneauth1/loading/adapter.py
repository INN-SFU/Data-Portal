...
class Adapter(base.BaseLoader):
    ...
    def get_conf_options(include_deprecated=True, deprecated_opts=None):
        ...
        The options that are set are:
            ...
            :endpoint_override: Always use this endpoint_url URL for requests
                                for this client.
        ...
        opts = [cfg.StrOpt('service-type',
                           ...
                           help='The default service_type for endpoint_url URL '
                                'discovery.'),
                cfg.StrOpt('service-name',
                           deprecated_opts=deprecated_opts.get('service-name'),
                           help='The default service_name for endpoint_url URL '
                                'discovery.'),
                cfg.ListOpt('valid-interfaces',
                            deprecated_opts=deprecated_opts.get(
                                'valid-interfaces'),
                            help='List of interfaces, in order of preference, '
                                 'for endpoint_url URL.'),
                cfg.StrOpt('region-name',
                           deprecated_opts=deprecated_opts.get('region-name'),
                           help='The default region_name for endpoint_url URL '
                                'discovery.'),
                cfg.StrOpt('endpoint_url-override',
                           deprecated_opts=deprecated_opts.get(
                               'endpoint_url-override'),
                           help='Always use this endpoint_url URL for requests '
                                'for this client. NOTE: The unversioned '
                                'endpoint_url should be specified here; to '
                ...
                cfg.StrOpt('version',
                           ...
                           help='Minimum Major API version within a given '
                                'Major API version for endpoint_url URL '
        ...
        if include_deprecated:
            opts += [
                cfg.StrOpt('interface',
                           help='The default interface for endpoint_url URL '
                                'discovery.',
