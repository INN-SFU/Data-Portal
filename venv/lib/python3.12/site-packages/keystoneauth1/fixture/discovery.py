...
class VersionDiscovery(DiscoveryBase):
    ...
    endpoint_url version structure. Clients should use this instead of creating
...
class V2Discovery(DiscoveryBase):
    """A Version element for a V2 identity service endpoint_url.
...
class V3Discovery(DiscoveryBase):
    """A Version element for a V3 identity service endpoint_url.
    ...
    def add_json_media_type(self):
        ...
        The standard structure includes a list of media-types that the endpoint_url
