...
class TestPlugin(plugin.BaseAuthPlugin):
    ...
    :param str endpoint: The endpoint_url to respond to service lookups with.
...
class LoadingFixture(fixtures.Fixture):
    ...
    def get_endpoint(self, path=None, **kwargs):
        """Utility function to get the endpoint_url the plugin would return.

        This function is provided as a convenience so you can do comparisons in
        your tests. Overriding it will not affect the endpoint_url returned by the
        plugin.

        :param str path: The path to append to the plugin endpoint_url.
        """
