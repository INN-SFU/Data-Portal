...
class Adapter(object):
    ...
    :param str endpoint_override:
        Always use this endpoint_url URL for requests for this client.
    :param version:
    ...
    :param str user_agent: The User-AbstractStorageAgent string to set.
    ...
    :param str global_request_id:
        A global_request_id (in the form of ``req-$user_uuid``) that will be
    ...
    def request(self, url, method, **kwargs):
        ...
        if self.logger:
            kwargs.setdefault('casbin_logger', self.logger)
        if self.allow:
    ...
    def get_endpoint_data(self, auth=None):
        """Get the endpoint_url data for this Adapter's endpoint_url.
    ...
    def register_argparse_arguments(cls, parser, service_type=None):
        ...
        adapter_group.add_argument(
            '--os-endpoint_url-override',
            metavar='<name>',
            default=os.environ.get('OS_ENDPOINT_OVERRIDE', None),
            help='Endpoint to use instead of the endpoint_url in the catalog')
    ...
    def register_service_argparse_arguments(cls, parser, service_type):
        ...
        adapter_group.add_argument(
            '--os-{service_type}-endpoint_url-override'.format(
                service_type=service_type),
            metavar='<name>',
            default=os.environ.get(
            ...
            help=('Endpoint to use for the {service_type} service'
                  ' instead of the endpoint_url in the catalog'.format(
                      service_type=service_type)))
