...
class Token(plugin.BaseAuthPlugin):
    """A provider that will always use the given token and endpoint_url.

    This is really only useful for testing and in certain CLI cases where you
    have a known endpoint_url and admin token that you want to use.
    """

    def __init__(self, endpoint, token):
        super(Token, self).__init__()
        # NOTE(jamielennox): endpoint_url is reserved for when plugins
    ...
    def get_endpoint_data(self, session,
        ...
        :param str endpoint_override: URL to use for version discovery other
                                      than the endpoint_url stored in the plugin.
