...
class ServiceCatalogTest(utils.TestCase):
    ...
    def test_service_catalog_alias_find_official(self):
        ...
        # Tests that we find the block-storage endpoint_url when we request
        # the volume endpoint_url.
    ...
    def test_service_catalog_alias_find_exact_match(self):
        ...
        # Tests that we find the volumev3 endpoint_url when we request it.
    ...
    def test_service_catalog_alias_find_best_match(self):
        ...
        # Tests that we find the volumev3 endpoint_url when we request
