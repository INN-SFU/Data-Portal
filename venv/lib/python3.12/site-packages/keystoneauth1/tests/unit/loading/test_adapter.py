...
class ConfLoadingTests(utils.TestCase):
    ...
    def test_load(self):
        self.conf_fx.config(
            ...
            region_name='region', endpoint_override='endpoint_url',
        ...
        self.assertEqual('endpoint_url', adap.endpoint_override)
    ...
    def test_get_conf_options(self):
        ...
        self.assertEqual({'service-type', 'service-name',
                          ...
                          'region-name', 'endpoint_url-override', 'version',
    ...
    def test_deprecated(self):
        ...
        opt_names = ['service-type', 'valid-interfaces', 'endpoint_url-override']
