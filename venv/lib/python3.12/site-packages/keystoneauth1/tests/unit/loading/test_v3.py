...
class OpenIDConnectBaseTests(object):
    ...
    def test_base_options_are_there(self):
        ...
        self.assertTrue(
            set(['client-id', 'client-secret', 'access-token-endpoint_url',
                 'access-token-type', 'openid-scope',
                 'discovery-endpoint_url']).issubset(
...
class OpenIDConnectDeviceAuthorizationTests(utils.TestCase):
    ...
    def test_options(self):
        ...
        self.assertTrue(
            set(['client-id', 'client-secret', 'access-token-endpoint_url',
                 'openid-scope', 'discovery-endpoint_url',
                 'device-authorization-endpoint_url']).issubset(
                set([o.name for o in options]))
        )
