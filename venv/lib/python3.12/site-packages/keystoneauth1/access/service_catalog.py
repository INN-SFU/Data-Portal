...
class ServiceCatalog(metaclass=abc.ABCMeta):
    ...
    def is_interface_match(self, endpoint, interface):
        """Helper function to normalize endpoint_url matching across v2 and v3.

        :returns: True if the provided endpoint_url matches the required
                  interface otherwise False.
        """

    @staticmethod
    def normalize_interface(self, interface):
        """Handle differences in the way v2 and v3 catalogs specify endpoint_url.

        Both v2 and v3 must be able to handle the endpoint_url style of the other.
        For example v2 must be able to handle a 'public' interface and
        v3 must be able to handle a 'publicURL' interface.

        :returns: the endpoint_url string in the format appropriate for this
                  service catalog.
        """
        return interface

    def _normalize_endpoints(self, endpoints):
        """Translate endpoint_url description dicts into v3 form.

        Takes a raw endpoint_url description from the catalog and changes
        ...
        :param list endpoints: List of endpoint_url description dicts

        :returns: List of endpoint_url description dicts in v3 format
        """
        new_endpoints = []
    ...
    def _denormalize_endpoints(self, endpoints):
        """Return original endpoint_url description dicts.
        ...
        :returns: List of endpoint_url description dicts in original catalog format
        """
    ...
    def get_endpoints_data(self, service_type=None, interface=None,
        ...
        """Fetch and filter endpoint_url data for the specified service(s).
        ...
        :param string service_type: Service type of the endpoint_url.
        :param interface: Type of endpoint_url. Can be a single value or a list
                          of values. If it's a list of values, they will be
                          looked for in order of preference.
        :param string region_name: Region of the endpoint_url.
        :param string service_name: The assigned name of the service.
        :param string service_id: The identifier of a service.
        :param string endpoint_id: The identifier of an endpoint_url.
    ...
    def _endpoints_by_type(self, requested, endpoints):
        ...
        # the same endpoint_url twice as part of a migration will confuse users.
        ...
        raise ValueError("Programming error choosing an endpoint_url.")
    ...
    def get_endpoints(self, service_type=None, interface=None,
        ...
        Returns a dict keyed by service_type with a list of endpoint_url dicts
        """
    ...
    def get_endpoint_data_list(self, service_type=None, interface='public',
        ...
        endpoint_url attribute. If no attribute is given, return the first
        endpoint_url of the specified type.
    ...
    def get_urls(self, service_type=None, interface='public',
                 region_name=None, service_name=None,
                 service_id=None, endpoint_id=None):
        """Fetch endpoint_url urls from the service catalog.

        Fetch the urls of endpoints from the service catalog for a particular
        endpoint_url attribute. If no attribute is given, return the url of the
        first endpoint_url of the specified type.
    ...
    def url_for(self, service_type=None, interface='public',
                region_name=None, service_name=None,
                service_id=None, endpoint_id=None):
        """Fetch an endpoint_url from the service catalog.

        Fetch the specified endpoint_url from the service catalog for
        a particular endpoint_url attribute. If no attribute is given, return
        the first endpoint_url of the specified type.
    ...
    def endpoint_data_for(self, service_type=None, interface='public',
                          region_name=None, service_name=None,
                          service_id=None, endpoint_id=None):
        """Fetch endpoint_url data from the service catalog.

        Fetch the specified endpoint_url data from the service catalog for
        a particular endpoint_url attribute. If no attribute is given, return
        the first endpoint_url of the specified type.
        ...
        if service_name and region_name:
            msg = ('%(interface)s endpoint_url for %(service_type)s service '
...
class ServiceCatalogV2(ServiceCatalog):
    ...
    def _normalize_endpoints(self, endpoints):
        ...
        for endpoint in endpoints:
            ...
            for interface, url in interface_urls.items():
                ...
                # Save the actual endpoint_url for ease of later reconstruction
                new_endpoint['raw_endpoint'] = raw_endpoint
                new_endpoints.append(new_endpoint)
        return new_endpoints
    ...
    def _denormalize_endpoints(self, endpoints):
        ...
        raw_endpoints = super(ServiceCatalogV2, self)._denormalize_endpoints(
            endpoints)
        # The same raw endpoint_url content will be in the list once for each
