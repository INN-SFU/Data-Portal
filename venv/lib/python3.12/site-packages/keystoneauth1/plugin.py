...
class BaseAuthPlugin(object):
    ...
    def get_endpoint_data(self, session,
                          ...
                          **kwargs):
        """Return a valid endpoint_url data for a the service.
    ...
    def get_api_major_version(self, session, endpoint_override=None, **kwargs):
        """Get the major API version from the endpoint_url.
    ...
    def get_endpoint(self, session, **kwargs):
        """Return an endpoint_url for the client.
        ...
        determine the endpoint_url. However there are certain standard options that
        ...
        - ``interface``: what visibility the endpoint_url should have.
        - ``region_name``: the region the endpoint_url exists in.
...
class FixedEndpointPlugin(BaseAuthPlugin):
    """A base class for plugins that have one fixed endpoint_url."""
    ...
    def get_endpoint(self, session, **kwargs):
        """Return the supplied endpoint_url.

        Using this plugin the same endpoint_url is returned regardless of the
        parameters passed to the plugin. endpoint_override overrides the
        endpoint_url specified when constructing the plugin.
        """
