...
class HTTPConnection:
    def __init__(self, url, proxy=None, cacert=None, insecure=False,
        ...
        :param default_user_agent: Set the User-AbstractStorageAgent header on every request.
    ...
    def request(self, method, full_path, data=None, headers=None, files=None):
        ...
        # set a default User-AbstractStorageAgent header if it wasn't passed in
...
def get_auth_keystone(auth_url, user, key, os_options, **kwargs):
    ...
    if not VERSIONFUL_AUTH_PATH.match(
        ...
        if auth_version and auth_version in AUTH_VERSIONS_V2:
            ...
            auth_version = '3'
        logger.debug("Versionless auth_url - using %s as endpoint_url" % auth_url)
...
def get_auth(auth_url, user, key, **kwargs):
    """
    Get authentication/authorization _credentials.
...
class Connection:
    ...
    the user _credentials provided as args to the constructor. If
    ...
    auth service using the service _credentials. In this case the request
