...
class ServiceCatalogV1:
    ...
    def endpoint_data_for(self, **kwargs):
        ...
        # url_for() (including `openstack endpoint_url list`) will know what to do
...
class PasswordPlugin(base.BaseIdentityPlugin):
    ...
    :param string auth_url: Identity v1 endpoint_url for authorization.
    ...
    def get_auth_ref(self, session, **kwargs):
        """Obtain a token from a v1 endpoint_url.
