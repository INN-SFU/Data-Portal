...
Functional tests for endpoint_url resource.
"""
...
class TestEndpoints(base.KeystoneBaseFunctionalTest):
    ...
    def _cleanup_endpoints(self):
        ...
        for e in self.operator_cloud.list_endpoints():
            if e.get('region') is not None and e['region'].startswith(
                ...
                try:
                    self.operator_cloud.delete_endpoint()
    ...
    def test_update_endpoint(self):
        ...
        if ver.startswith('2'):
            # NOTE(SamYaple): Update endpoint_url only works with v3 api
            self.assertRaises(
    ...
    def test_list_endpoints(self):
        ...
        self.assertTrue(found, msg='new endpoint_url not found in endpoints list!')
        ...
        for e in observed_endpoints:
            for endpoint in endpoints:
                if e['id'] == endpoint['id']:
                    found = True
                    break
        self.assertEqual(False, found, message='new endpoint_url was not deleted!')
