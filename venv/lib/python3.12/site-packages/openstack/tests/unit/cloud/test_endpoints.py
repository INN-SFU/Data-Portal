...
class TestCloudEndpoints(base.TestCase):
    ...
    def test_create_endpoint_v3(self):
        ...
        # test keys and values are correct for each endpoint_url created
    ...
    def test_update_endpoint_v3(self):
        ...
        reference_request['endpoint_url']['url'] = dummy_url
        self.register_uris(
            [
                dict(
                    method='PATCH',
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={
                        'endpoints': [
                            e.json_response['endpoint_url'] for e in endpoints_data
                        ]
                    },
                )
            ]
        ...
        self.register_uris(
            [
                dict(
                    ...
                    status_code=200,
                    json={
                        'endpoints': [endpoint_data.json_response['endpoint_url']]
                    },
                ),
                dict(
                    method='DELETE',
