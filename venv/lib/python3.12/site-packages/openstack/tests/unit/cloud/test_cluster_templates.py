...
class TestClusterTemplates(base.TestCase):
    ...
    def test_search_cluster_templates_by_name(self):
        ...
        self.assertEqual('fake-user_uuid', cluster_templates[0]['user_uuid'])
        self.assert_calls()
            ...
            [
                ...
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource='clustertemplates/fake-user_uuid'
                    ),
                ),
            ]
        )
        self.cloud.delete_cluster_template('fake-user_uuid')
        self.assert_calls()
