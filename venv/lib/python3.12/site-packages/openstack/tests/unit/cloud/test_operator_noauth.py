...
class TestOpenStackCloudOperatorNoAuth(base.TestCase):
    def setUp(self):
        ...
        Setup the test to utilize no authentication and an endpoint_url
    ...
    def test_ironic_noauth_none_auth_type(self):
        ...
        # with 'v1'. As such, since we are overriding the endpoint_url,
    ...
    def test_ironic_noauth_auth_endpoint(self):
        ...
        ::
          clouds:
            bifrost:
              auth_type: "none"
              endpoint_url: https://baremetal.example.com
        """
        self.cloud_noauth = openstack.connect(
            auth_type='none',
