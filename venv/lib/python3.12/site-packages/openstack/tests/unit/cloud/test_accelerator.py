...
class TestAccelerator(base.TestCase):
    ...
    def test_list_deployables(self):
        ...
        self.assertEqual(dep_list[0].id, DEP_DICT['user_uuid'])
    ...
    def test_list_devices(self):
        ...
        self.assertEqual(dev_list[0].user_uuid, DEV_DICT['user_uuid'])
    ...
    def test_list_device_profiles(self):
        ...
        self.assertEqual(dev_prof_list[0].user_uuid, DEV_PROF_DICT['user_uuid'])
    ...
    def test_list_accelerator_requests(self):
        ...
        self.assertEqual(arq_list[0].user_uuid, ARQ_DICT['user_uuid'])
        self.assertEqual(
    ...
    def test_delete_accelerator_request(self, filters=None):
        ...
        self.assertTrue(
            self.cloud.delete_accelerator_request(ARQ_DICT['user_uuid'], filters)
        )
        self.assert_calls()
    ...
    def test_bind_accelerator_request(self):
        ...
        self.assertTrue(
            self.cloud.bind_accelerator_request(ARQ_DICT['user_uuid'], properties)
        )
        self.assert_calls()
    ...
    def test_unbind_accelerator_request(self):
        ...
        self.assertTrue(
            self.cloud.unbind_accelerator_request(ARQ_DICT['user_uuid'], properties)
        )
        self.assert_calls()
