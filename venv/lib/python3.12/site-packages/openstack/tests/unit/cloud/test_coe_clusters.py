...
class TestCOEClusters(base.TestCase):
    ...
    def test_create_coe_cluster(self):
        json_response = dict(uuid=coe_cluster_obj.get("user_uuid"))
        kwargs = dict(
    ...
    def test_search_coe_cluster_by_name(self):
        ...
        self.assertEqual(coe_cluster_obj["user_uuid"], coe_clusters[0]["id"])
        self.assert_calls()
            ...
            [
                ...
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource="clusters", append=[coe_cluster_obj['user_uuid']]
                    ),
                ),
            ]
        )
        self.cloud.delete_coe_cluster(coe_cluster_obj["user_uuid"])
        self.assert_calls()
    ...
    def test_update_coe_cluster(self):
        ...
        self.cloud.update_coe_cluster(coe_cluster_obj["user_uuid"], node_count=3)
        self.assert_calls()
