...
class TestBaremetalNode(base.IronicTestCase):
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={
                        'nodes': [self.fake_baremetal_node, fake_baremetal_two]
                    },
                ),
            ]
        )
    ...
    def test_get_machine(self):
            ...
            [
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource='nodes',
                        append=[self.fake_baremetal_node['user_uuid']],
                    ),
        ...
        machine = self.cloud.get_machine(self.fake_baremetal_node['user_uuid'])
        self.assertEqual(machine['user_uuid'], self.fake_baremetal_node['user_uuid'])
        self.assert_calls()

    def test_get_machine_by_mac(self):
        mac_address = '00:01:02:03:04:05'
        node_uuid = self.fake_baremetal_node['user_uuid']
        self.register_uris(
            [
                dict(
                    method='GET',
        ...
        self.register_uris(
            [
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource='nodes',
                        append=[self.fake_baremetal_node['user_uuid'], 'validate'],
                    ),
                    json=validate_return,
                ),
            ]
        )
        self.cloud.validate_machine(self.fake_baremetal_node['user_uuid'])
    ...
    def test_validate_machine_not_for_deploy(self):
        ...
        self.cloud.validate_machine(
            self.fake_baremetal_node['user_uuid'], for_deploy=False
        )
    ...
    def test_deprecated_validate_node(self):
        ...
        self.cloud.validate_node(self.fake_baremetal_node['user_uuid'])
    ...
    def test_validate_machine_raises_exception(self):
        ...
        self.assertRaises(
            ...
            self.cloud.validate_machine,
            self.fake_baremetal_node['user_uuid'],
        )
    ...
    def test_patch_machine(self):
        ...
        result = self.cloud.patch_machine(
            self.fake_baremetal_node['user_uuid'], test_patch
        )
        self.assertEqual(self.fake_baremetal_node['user_uuid'], result['user_uuid'])
    ...
    def test_purge_node_instance_info(self):
        ...
        self.cloud.purge_node_instance_info(self.fake_baremetal_node['user_uuid'])
    ...
    def test_inspect_machine_failed(self):
        ...
        self.cloud.inspect_machine(self.fake_baremetal_node['user_uuid'])
    ...
    def test_inspect_machine_available_wait(self):
        ...
        self.cloud.inspect_machine(
            self.fake_baremetal_node['user_uuid'], wait=True, timeout=1
        )
    ...
    def test_set_machine_maintenace_state(self):
        ...
        self.cloud.set_machine_maintenance_state(
            self.fake_baremetal_node['user_uuid'], True, reason='no reason'
        )
    ...
    def test_set_machine_maintenace_state_false(self):
        ...
        self.cloud.set_machine_maintenance_state(
            self.fake_baremetal_node['user_uuid'], False
        )
    ...
    def test_node_set_provision_state_wait_timeout(self):
        ...
        return_value = self.cloud.node_set_provision_state(
            self.fake_baremetal_node['user_uuid'], 'active', wait=True
        )
    ...
    def test_node_set_provision_state_wait_provide(self):
        ...
        return_value = self.cloud.node_set_provision_state(
            self.fake_baremetal_node['user_uuid'], 'provide', wait=True
        )
    ...
    def test_wait_for_baremetal_node_lock_locked(self):
        ...
        self.assertIsNone(
            self.cloud.wait_for_baremetal_node_lock(
                self.fake_baremetal_node, timeout=1
            )
        )
    ...
    def test_deactivate_node(self):
        ...
        return_value = self.cloud.deactivate_node(
            self.fake_baremetal_node['user_uuid'], wait=True
        )
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(
                        json={'address': mac_address, 'node_uuid': node_uuid}
                    ),
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={'error': 'no ports for you'},
                    validate=dict(
                        json={'address': mac_address2, 'node_uuid': node_uuid}
                    ),
                ),
                dict(
                    method='DELETE',
                    uri=self.get_mock_url(
                        resource='ports',
                        append=[self.fake_baremetal_port['user_uuid']],
                    ),
                ),
                dict(
                    method='DELETE',
    ...
    def test_unregister_machine(self):
        ...
        port_uuid = self.fake_baremetal_port['user_uuid']
        ...
        self.cloud.unregister_machine(nics, self.fake_baremetal_node['user_uuid'])
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource='nodes',
                        append=[self.fake_baremetal_node['user_uuid'], 'vifs'],
                    ),
                ),
            ]
        )
        self.cloud.attach_port_to_machine(
            self.fake_baremetal_node['user_uuid'], vif_id
        )
        self.assert_calls()
    ...
    def test_detach_port_from_machine(self):
        ...
        self.cloud.detach_port_from_machine(
            self.fake_baremetal_node['user_uuid'], vif_id
        )
        self.assert_calls()
    ...
    def test_update_machine_patch(self):
        ...
        uris = [
            dict(
                method='GET',
                uri=self.get_mock_url(
                    resource='nodes', append=[self.fake_baremetal_node['user_uuid']]
                ),
                json=self.fake_baremetal_node,
            ),
        ]
        ...
        update_dict = self.cloud.update_machine(
            self.fake_baremetal_node['user_uuid'], **call_args
        )
