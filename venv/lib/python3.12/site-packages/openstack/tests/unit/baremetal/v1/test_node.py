...
FAKE = {
    ...
    "target_raid_config": {},
    "updated_at": None,
    "user_uuid": "6d85703a-565d-469a-96ce-30b6de53079d",
}
...
class TestNode(base.TestCase):
    ...
    def test_instantiate(self):
        ...
        self.assertEqual(FAKE['user_uuid'], sot.id)
...
class TestNodeWaitForProvisionState(base.TestCase):
    ...
    def test_enroll_as_failure(self, mock_fetch):
        ...
        self.assertRaisesRegex(
            exceptions.ResourceFailure,
            'failed to verify management _credentials',
            self.node.wait_for_provision_state,
            self.session,
            'manageable',
        )
...
class TestNodeInjectNMI(base.TestCase):
    ...
    def test_inject_nmi(self):
        ...
        self.session.put.assert_called_once_with(
            'nodes/%s/management/inject_nmi' % FAKE['user_uuid'],
            json={},
            headers=mock.ANY,
            microversion='1.29',
            retriable_status_codes=_common.RETRIABLE_STATUS_CODES,
...
class TestNodeSetPowerState(base.TestCase):
    ...
    def test_power_on(self):
        ...
        self.session.put.assert_called_once_with(
            'nodes/%s/states/power' % FAKE['user_uuid'],
