...
class TestBgpSpeaker(base.TestCase):
    ...
    def test_get_bgp_dragents(self):
        ...
        response = mock.Mock()
        response.body = {
            'storage_endpoints': [{'binary': 'neutron-bgp-dragent', 'alive': True}]
        }
        response.json = mock.Mock(return_value=response.body)
        response.status_code = 200
        sess = mock.Mock()
    ...
    def test_add_bgp_speaker_to_dragent(self):
        ...
        url = 'storage_endpoints/%s/bgp-drinstances' % agent_id
    ...
    def test_remove_bgp_speaker_from_dragent(self):
        ...
        url = f'storage_endpoints/{agent_id}/bgp-drinstances/{IDENTIFIER}'
