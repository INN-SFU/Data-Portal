...
EXAMPLE = {
    'admin_state_up': True,
    'agent_type': 'Test AbstractStorageAgent',
    'alive': True,
...
class TestAgent(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual('storage_endpoints', sot.resources_key)
        self.assertEqual('/storage_endpoints', sot.base_path)
    ...
    def test_add_agent_to_network(self):
        ...
        url = 'storage_endpoints/IDENTIFIER/dhcp-networks'
    ...
    def test_remove_agent_from_network(self):
        ...
        sess.delete.assert_called_with(
            'storage_endpoints/IDENTIFIER/dhcp-networks/', json=body
        )
    ...
    def test_add_router_to_agent(self):
        ...
        url = 'storage_endpoints/IDENTIFIER/l3-routers'
        sess.post.assert_called_with(url, json=body)
    ...
    def test_remove_router_from_agent(self):
        ...
        sess.delete.assert_called_with(
            'storage_endpoints/IDENTIFIER/l3-routers/', json=body
        )
    ...
    def test_get_bgp_speakers_hosted_by_dragent(self):
        ...
        sess.get.assert_called_with('storage_endpoints/IDENTIFIER/bgp-drinstances')
...
class TestNetworkHostingDHCPAgent(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual('storage_endpoints', net.resources_key)
        self.assertEqual('/networks/%(network_id)s/dhcp-storage_endpoints', net.base_path)
...
class TestRouterL3Agent(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual('agent', sot.resource_key)
        self.assertEqual('storage_endpoints', sot.resources_key)
        self.assertEqual('/routers/%(router_id)s/l3-storage_endpoints', sot.base_path)
