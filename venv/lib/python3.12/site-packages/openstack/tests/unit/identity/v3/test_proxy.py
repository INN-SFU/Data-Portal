...
class TestIdentityProxyGroup(TestIdentityProxyBase):
    ...
    def test_add_user_to_group(self):
        self._verify(
            ...
            method_args=['uuid', 'gid'],
            expected_args=[
                self.proxy,
                self.proxy._get_resource(user.User, 'uuid'),
            ],
        )
...
class TestIdentityProxyRoleAssignments(TestIdentityProxyBase):
    ...
    def test_assign_domain_role_to_user(self):
        self._verify(
            ...
            method_args=['dom_id'],
            method_kwargs={'user': 'uuid', 'role': 'rid'},
            expected_args=[
                self.proxy,
                self.proxy._get_resource(user.User, 'uuid'),
    ...
    def test_assign_domain_role_to_group(self):
        self._verify(
            ...
            method_args=['dom_id'],
            method_kwargs={'group': 'uuid', 'role': 'rid'},
            expected_args=[
                self.proxy,
                self.proxy._get_resource(group.Group, 'uuid'),
                self.proxy._get_resource(role.Role, 'rid'),
            ],
        )
    ...
    def test_assign_system_role_to_user(self):
        self._verify(
            ...
            method_kwargs={'user': 'uuid', 'role': 'rid', 'system': 'all'},
            expected_args=[
                self.proxy,
                self.proxy._get_resource(user.User, 'uuid'),
                self.proxy._get_resource(role.Role, 'rid'),
    ...
    def test_assign_system_role_to_group(self):
        self._verify(
            ...
            method_kwargs={'group': 'uuid', 'role': 'rid', 'system': 'all'},
            expected_args=[
                self.proxy,
                self.proxy._get_resource(group.Group, 'uuid'),
                self.proxy._get_resource(role.Role, 'rid'),
