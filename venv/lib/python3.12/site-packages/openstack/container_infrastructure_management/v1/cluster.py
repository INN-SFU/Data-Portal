...
class Cluster(resource.Resource):
    ...
    #: The endpoint_url URL of COE API exposed to end-users.
    ...
    #: the API endpoint_url for the bay/cluster and to direct requests to the
    ...
    #: endpoint_url. The default is true, i.e. to create the load balancer for the
    #: bay.
    ...
    uuid = resource.Body('user_uuid', alternate_id=True)
