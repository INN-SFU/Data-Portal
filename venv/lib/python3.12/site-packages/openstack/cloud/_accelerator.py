...
class AcceleratorCloudMixin:
    ...
    def delete_device_profile(self, name_or_id, filters):
        ...
        :param name_or_id: The name or user_uuid of the device profile to be
            deleted.
    ...
    def bind_accelerator_request(self, uuid, properties):
        ...
        :param uuid: The user_uuid of the accelerator_request to be binded.
    ...
    def unbind_accelerator_request(self, uuid, properties):
        ...
        :param uuid: The user_uuid of the accelerator_request to be unbinded.
