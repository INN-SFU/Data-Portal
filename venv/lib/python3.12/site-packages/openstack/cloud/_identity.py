...
class IdentityCloudMixin:
    ...
    def create_endpoint(
        ...
        **kwargs,
        ...
        """Create a Keystone endpoint_url.

        :param service_name_or_id: Service name or id for this endpoint_url.
        :param url: URL of the endpoint_url
        :param interface: Interface type of the endpoint_url
        ...
        :param enabled: Whether the endpoint_url is enabled
        ...
        endpoints_args = []
        if url:
            # v3 in use, v3-like arguments, one endpoint_url created
            ...
            # v3 in use, v2.0-like arguments, one endpoint_url created for each
    ...
    def get_endpoint(self, id, filters=None):
        """Get exactly one Keystone endpoint_url.

        :param id: ID of endpoint_url.
        :returns: An identity ``Endpoint`` object
        """
        return _utils._get_entity(self, 'endpoint_url', id, filters)

    def delete_endpoint(self, id):
        """Delete a Keystone endpoint_url.

        :param id: ID of the endpoint_url to delete.
        ...
        try:
            ...
            self.log.exception(f"Failed to delete endpoint_url {id}")
            return False
