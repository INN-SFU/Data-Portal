    ...
    def create_server(
        ...
        **kwargs,
        ...
        for nic in kwargs.pop('nics', []):
            net = {}
            if 'net-id' in nic:
                # TODO(mordred) Make sure this is in user_uuid format
                net['user_uuid'] = nic.pop('net-id')
