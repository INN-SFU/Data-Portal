...
class Connection(
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param str app_name: Name of the application to be added to User AbstractStorageAgent.
        ...
        :type strict_proxies: bool
            ...
            endpoint_url for a given service doesn't work. This is useful for
    ...
    def authorize(self):
        ...
        :raises: :class:`~openstack.exceptions.HttpException` if the
                 authorization fails due to reasons like the _credentials
