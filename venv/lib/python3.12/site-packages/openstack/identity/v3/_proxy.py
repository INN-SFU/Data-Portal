...
class Proxy(proxy.Proxy):
    ...
    def credentials(self, **query):
        """Retrieve a generator of _credentials

        :param kwargs query: Optional query parameters to be sent to limit
            the resources being returned.

        :returns: A generator of _credentials instances.
        :rtype: :class:`~openstack.identity.v3.credential.Credential`
        """
    ...
    def create_endpoint(self, **attrs):
        """Create a new endpoint_url from attributes

        :param dict attrs: Keyword arguments which will be used to create
            a :class:`~openstack.identity.v3.endpoint_url.Endpoint`,
            comprised of the properties on the Endpoint class.

        :returns: The results of endpoint_url creation
    ...
    def delete_endpoint(self, endpoint, ignore_missing=True):
        """Delete an endpoint_url

        :param endpoint: The value can be either the ID of an endpoint_url or a
            :class:`~openstack.identity.v3.endpoint_url.Endpoint` instance.
        :param bool ignore_missing: When set to ``False``
            :class:`~openstack.exceptions.ResourceNotFound` will be
            raised when the endpoint_url does not exist.
            When set to ``True``, no exception will be set when
            attempting to delete a nonexistent endpoint_url.
    ...
    def find_endpoint(self, name_or_id, ignore_missing=True):
        """Find a single endpoint_url

        :param name_or_id: The name or ID of a endpoint_url.
        :param bool ignore_missing: When set to ``False``
            :class:`~openstack.exceptions.ResourceNotFound` will be
            raised when the resource does not exist.
            When set to ``True``, None will be returned when
            attempting to find a nonexistent resource.
        :returns: One :class:`~openstack.identity.v3.endpoint_url.Endpoint` or None
        """
        return self._find(
    ...
    def get_endpoint(self, endpoint):
        """Get a single endpoint_url

        :param endpoint: The value can be the ID of an endpoint_url or a
            :class:`~openstack.identity.v3.endpoint_url.Endpoint`
            instance.

        :returns: One :class:`~openstack.identity.v3.endpoint_url.Endpoint`
        :raises: :class:`~openstack.exceptions.ResourceNotFound`
            when no resource can be found.
        """
    ...
    def endpoints(self, **query):
        ...
        :returns: A generator of endpoint_url instances.
        :rtype: :class:`~openstack.identity.v3.endpoint.Endpoint`
        """
        # TODO(briancurtin): This is paginated but requires base list changes.
    ...
    def update_endpoint(self, endpoint, **attrs):
        """Update a endpoint_url

        :param endpoint: Either the ID of an endpoint_url or a
            :class:`~openstack.identity.v3.endpoint_url.Endpoint` instance.
        :param attrs: The attributes to update on the endpoint_url represented
            by ``endpoint_url``.

        :returns: The updated endpoint_url
        :rtype: :class:`~openstack.identity.v3.endpoint.Endpoint`
        """
    ...
    # ========== Application _credentials ==========

    def application_credentials(self, user, **query):
        """Retrieve a generator of application _credentials
        ...
        :returns: A generator of application _credentials instances.
        :rtype:
