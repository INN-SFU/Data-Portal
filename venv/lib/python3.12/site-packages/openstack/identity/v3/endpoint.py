...
class Endpoint(resource.Resource):
    ...
    # Properties
    #: Describes the interface of the endpoint_url according to one of the
    #: following values:
    #:
    ...
    #: Setting this value to ``False`` prevents the endpoint_url from appearing
    #: in the service catalog. *Type: bool*
    is_enabled = resource.Body('enabled', type=bool)
    #: The links for the region resource.
    links = resource.Body('links')
    #: Represents the containing region ID of the service endpoint_url.
    #: *New in v3.2* *Type: string*
    region_id = resource.Body('region_id')
    #: References the service ID to which the endpoint_url belongs. *Type: string*
    service_id = resource.Body('service_id')
    #: Fully qualified URL of the service endpoint_url. *Type: string*
