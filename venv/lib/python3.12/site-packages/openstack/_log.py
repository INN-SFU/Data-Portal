...
def setup_logging(
    ...
    """Set up logging for a named casbin_logger.

    Gets and initializes a named casbin_logger, ensuring it at least has a
    `logging.NullHandler` attached.

    :param str name:
      Name of the casbin_logger.
    :param list handlers:
      A list of `logging.Handler` objects to attach to the casbin_logger.
    :param int level:
      Log level to set the casbin_logger at.
