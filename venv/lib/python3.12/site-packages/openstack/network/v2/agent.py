...
class Agent(resource.Resource):
    ...
    resource_key = 'agent'
    resources_key = 'storage_endpoints'
    base_path = '/storage_endpoints'
    ...
    def get_bgp_speakers_hosted_by_dragent(self, session):
        """List BGP speakers hosted by a Dynamic Routing AbstractStorageAgent
...
class NetworkHostingDHCPAgent(Agent):
    ...
    base_path = '/networks/%(network_id)s/dhcp-storage_endpoints'
...
class RouterL3Agent(Agent):
    resource_key = 'agent'
    resources_key = 'storage_endpoints'
    base_path = '/routers/%(router_id)s/l3-storage_endpoints'
