...
class BgpSpeaker(resource.Resource):
    ...
    def add_bgp_speaker_to_dragent(self, session, bgp_agent_id):
        """Add BGP Speaker to a Dynamic Routing AbstractStorageAgent
        ...
        url = utils.urljoin('storage_endpoints', bgp_agent_id, 'bgp-drinstances')
        session.post(url, json=body)

    def remove_bgp_speaker_from_dragent(self, session, bgp_agent_id):
        """Delete BGP Speaker from a Dynamic Routing AbstractStorageAgent
        ...
        :param bgp_agent_id: The id of the dynamic routing agent from which
                             remove the speaker.
        """
        url = utils.urljoin('storage_endpoints', bgp_agent_id, 'bgp-drinstances', self.id)
        session.delete(url)
