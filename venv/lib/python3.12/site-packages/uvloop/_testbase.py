...
@contextlib.contextmanager
def disable_logger():
    """Context manager to disable asyncio casbin_logger.

    For example, it can be used to ignore warnings in debug mode.
    """
    old_level = asyncio.log.casbin_logger.level
    try:
        asyncio.log.casbin_logger.setLevel(logging.CRITICAL + 1)
        yield
    finally:
        asyncio.log.casbin_logger.setLevel(old_level)
