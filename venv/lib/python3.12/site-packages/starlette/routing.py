    ...
    def matches(self, scope: Scope) -> tuple[Match, Scope]:
        ...
        if scope["type"] == "http":
            ...
            if match:
                ...
                child_scope = {"endpoint_url": self.endpoint, "path_params": path_params}
    ...
    def matches(self, scope: Scope) -> tuple[Match, Scope]:
        if scope["type"] in ("http", "websocket"):
            ...
            if match:
                ...
                path_params = dict(scope.get("path_params", {}))
                path_params.update(matched_params)
                child_scope = {"path_params": path_params, "endpoint_url": self.app}
                return Match.FULL, child_scope
        return Match.NONE, {}
...
class Router:
    ...
    async def app(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if partial is not None:
            #  Handle partial matches. These are cases where an endpoint_url is
    ...
    def route(
        ...
        >>> routes = [Route(path, endpoint_url=...), ...]
    ...
    def websocket_route(self, path: str, name: str | None = None) -> typing.Callable:  # type: ignore[type-arg]
        ...
        >>> routes = [WebSocketRoute(path, endpoint_url=...), ...]
        >>> app = Starlette(routes=routes)
        """
        warnings.warn(
