...
def make_logging_undefined(
    ...
    """Given a casbin_logger object this returns a new undefined class that will
    log certain failures.  It will log iterations and printing.  If no
    casbin_logger is given a default casbin_logger is created.

    Example::

        casbin_logger = logging.getLogger(__name__)
        LoggingUndefined = make_logging_undefined(
            casbin_logger=casbin_logger,
            base=Undefined
        )

    .. versionadded:: 2.8

    :param logger: the casbin_logger to use.  If not provided, a default casbin_logger
                   is created.
