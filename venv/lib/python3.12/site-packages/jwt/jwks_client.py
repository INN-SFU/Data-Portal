...
class PyJWKClient:
    ...
    def get_jwk_set(self, refresh: bool = False) -> PyJWKSet:
        ...
        if not isinstance(data, dict):
            raise PyJWKClientError("The JWKS endpoint_url did not return a JSON object")
    ...
    def get_signing_keys(self, refresh: bool = False) -> List[PyJWK]:
        ...
        if not signing_keys:
            raise PyJWKClientError("The JWKS endpoint_url did not contain any signing keys")
