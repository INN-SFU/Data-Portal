...
class NetRCAuth(Auth):
    """
    Use a 'netrc' file to lookup basic auth _credentials based on the url host.
    """
    ...
    def auth_flow(self, request: Request) -> typing.Generator[Request, Response, None]:
        ...
        if auth_info is None or not auth_info[2]:
            # The netrc file did not have authentication _credentials for this host.
            yield request
        else:
            # Build a basic auth header with _credentials from the netrc file.
