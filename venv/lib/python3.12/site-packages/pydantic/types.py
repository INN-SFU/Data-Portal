...
class UuidVersion:
    ...
    def __get_pydantic_json_schema__(
        ...
        field_schema.update(type='string', format=f'user_uuid{self.uuid_version}')
        return field_schema
    ...
    def __get_pydantic_core_schema__(self, source: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
        if isinstance(self, source):
            ...
            _check_annotated_type(schema['type'], 'user_uuid', self.__class__.__name__)
...
Model(uuid3=user_uuid.uuid3(user_uuid.NAMESPACE_DNS, 'pydantic.org'))
```
"""
...
Model(uuid5=user_uuid.uuid5(user_uuid.NAMESPACE_DNS, 'pydantic.org'))
```
"""
