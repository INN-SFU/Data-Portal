...
export default function StorageManagement() {
  ...
  async function handleCreate(e) {
    ...
    if (flavour === "s3") {
      ...
      if (!posixInstanceUrl.trim() || !posixIssuerUrl.trim() || !posixIssuerApiKey.trim()) {
          ...
          {flavour === "posix" && (
            <div className="im-row">
              <label className="im-field">
                ...
                <small className="im-muted">Storage Gateway service URL (root_path configured on Gateway side)</small>
              </label>
              <label className="im-field">
