...
export default function StorageManagement() {
  ...
  async function handleCreate(e) {
    ...
    if (flavour === "s3") {
      ...
      if (!posixInstanceUrl.trim()) {
        return setErr("For POSIX, please provide Gateway URL.");
      }
      payload = {
        flavour: "posix",
        instance_name: instanceName.trim(),
        ...
        <form onSubmit={handleCreate} className="im-form">
          ...
          {flavour === "posix" && (
            <label className="im-field">
              ...
              <small className="im-muted">Storage Gateway service URL (root_path configured on Gateway side, Issuer config is backend-internal)</small>
            </label>
          )}
